# Guardrails Fiscal (`grf`) — istruzioni di progetto
...
fonte, poi `python3 tools/build_modules.py --module grf`, poi commit qui.

## Cosa cambia rispetto al bundle

- il roster contiene solo le figure di quest'area
- le tre skill del core sono rinominate: `grf-setup`, `grf-profile`,
  `grf-board`
