...
| --- | --- | --- | --- |
| Software | BMM + Otto | Kai, Bruno, Enzo, TEA | test/release `grf-board` |
| Database e persistenza | Dario + BMM Architect | Otto, Bruno, Kai, Enzo, TEA | workload/glossario, ricerca live, benchmark, migrazione e release `grf-board` |
